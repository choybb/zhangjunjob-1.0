  ...
  <body>
      ...
      <!-- style="background-color:rgba(255, 255, 255, 0);背景透明度 -->
        <div class="jumbotron" style="background-color:rgba(255, 255, 255, 0);">
          <h1 class="display-3"><span style="color: beige; margin-left: 150px;">Shoes to buy</span> </h1>
          <p class="lead"><span style="color: beige; margin-left:150px;">球鞋购买</span></p>
          <p class="lead"><span style="color: beige; margin-left:150px;">My basketball dream</span></p>
        </div>
