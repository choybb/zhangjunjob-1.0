  ...
  <ul class="nav nav-tabs" style="background-color:  #2C343C; height: 70px;">
    <li class="nav-item disabled">
      <p href="#" class="nav-link nav-item disabled">
        ...
        <div class="headportrait1">Kris ni <br />Love Life Love You</div>
      </p>
    </li>
    <li class="nav-item ">
      <a class="nav-link" data-toggle="tab" href="#menu1">Home</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#menu2">Streams</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#menu3">About</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#menu4">Learn</a>
    </li>
    <li class="nav-item">
...
<form action="product">
  <!-- 轮播图 -->
  <div class="container-fluid" style="width: 1500px; height: 600px;margin: 50px auto; margin-top: 0px;">
    <div class="row">
      ...
      <div class="row" style="margin-top: 10px;">
        ...
        <div class="col-sm-3">
          <ul>
            ...
            <li>来自于长沙民政职业技术学院的学生，现在在牛耳进行学习，梦想成为 一名工程师。</li>
