...
<body>
  ...
  <div class="a4">
    <p style="color: beige;"><a href="zhujiemian.jsp">登陆主界面</a>  ||  <a href="shouye.jsp">登陆首页</a></p>
  </div>>
  ...
  <div class="a1">
    <div class="a2">
      ...
      <div class="form-group">
        ...
        <input type="text" id="a3" class="form-control" aria-describedby="helpId" onblur="run3()" placeholder="请再次输入密码">
